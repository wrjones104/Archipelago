...
def options(args):
    ...
    result.append(("Shuffle Steals", args.shuffle_steals))
    if args.shuffle_steals:
        result.append(("Random Percent", f"{args.shuffle_steals_random_percent}%"))

    result.append(("Shuffle Drops", args.shuffle_drops))
    if args.shuffle_drops:
        result.append(("Random Percent", f"{args.shuffle_drops_random_percent}%"))
    return result
