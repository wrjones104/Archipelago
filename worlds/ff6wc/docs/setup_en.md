# Final Fantasy 6 Worlds Collide Setup Guide
...
- Hardware or software capable of loading and playing SNES ROM files
    ...
    - An SD2SNES, FXPak Pro ([FXPak Pro Store Page](https://krikzz.com/store/home/54-fxpak-pro.html)), or other
      compatible hardware
- Your legally obtained v1.0 US SNES ROM file of Final Fantasy III, probably named `Final Fantasy III (USA).sfc`

## Installation Procedures

### Windows Setup

1. Download and run the Archipelago installer.
2. If you are using an emulator, you may want to assign your Lua capable emulator as your default program for launching ROM files.
...
them. Player settings page: [Final Fantasy 6 Worlds Collide Player Settings Page](/games/Final%20Fantasy%206%20Worlds%20Collide/player-settings)
...
files. Your patch file should have a `.apff6wc` extension.
